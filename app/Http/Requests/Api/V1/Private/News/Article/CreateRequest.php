...
final class CreateRequest extends AbstractRequest
{
    public function rules(): array
    {
        return [
            ...
            'slug' => ['required', 'string', 'min:1', 'unique:App\Models\News\Article,slug'],
            ...
            'preview_file_uuid' => ['required', 'uuid', 'exists:App\Models\Storage\File,uuid'],
            'main_file_uuid' => ['required', 'uuid', 'exists:App\Models\Storage\File,uuid'],
        ];
    }
    ...
    public function dto(): ArticlePipelineDto
    {
        return ArticlePipelineDto::fromArray([
            ...
            'preview_file_uuid' => $this->get('preview_file_uuid') ?? [],
            'main_file_uuid' => $this->get('main_file_uuid') ?? [],
        ]);
    }
}

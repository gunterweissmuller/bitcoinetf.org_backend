...
class ConstantServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        define('WALLET_CONNECT_MSG', 'I fully understand and agree to the Terms and Conditions (available at https://bitcoinetf.org/terms) and certify that I am not a US citizen, resident or taxpayer.');

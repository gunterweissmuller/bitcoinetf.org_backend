...
final class PgSqlProfileRepository implements ProfileRepositoryInterface
{
    ...
    public function create(ProfileDto $dto): ProfileDto
    {
        ...
        return ProfileDto::fromArray($model->toArray());
    }
    ...
    public function get(array $filters): ?ProfileDto
    {
        ...
        return $model ? ProfileDto::fromArray($model->toArray()) : null;
    }

                                            ...
                                            <tr>
                                                <td>
                                                    <p
                                                        ...
                                                        Welcome to <br> BitcoinETF.org
                                                    </p>
                                                </td>
                                                <td align="right">
                                                    <img alt=""
                                                         src="https://bitcoinetf.org/img/emails/7.png">
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                ...
                                <tr>
                                    ...
                                    <td class=float-lg width=343 align=start valign=center>
                                        <p
                                            ...
                                            Welcome to BitcoinETF.org, the forefront of decentralized investment innovation. As a
                                            discerning investor, you have taken the first step into a world where sophistication meets
                                            cutting-edge financial technology.
                                            <br>
                                            <br>
                                            Your interest in our tokenized ETF is much appreciated, and we are committed to providing
                                            you with an experience that stands out in the digital asset space. Our platform is designed
                                            to facilitate seamless acquisition of ETF shares, allowing you to manage your investment
                                            effortlessly.
                                        </p>
                                    </td>
                                    <td class=float-sm width=16>&nbsp;</td>
    ...
    <tr>
        <td align="left" bgcolor="#F7F7F7" style="background-color: #F7F7F7">
                                        ...
                                        <tr>
                                            ...
                                            <td class="float-lg" width="343" align="start" valign="start">
                                                <p style="Margin:0;font-family:'DM Sans', Arial;font-size:24px;line-height:normal;color:#22242B;font-weight:700;text-align:start">
                                                    What you can expect as you <span style="Margin:0;font-family:'DM Sans', Arial;font-size:24px;line-height:normal;color:#0066FF;font-weight:700;text-align:start;">embark on your investment journey</span>
                                                    with us
                                                </p>
                                            </td>
                                            <td class="float-sm" width="16">&nbsp;</td>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                ...
                <tr>
                    <td align="center">
                        <table class="container" align="center" width="375" cellpadding="0" cellspacing="0" border="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                            <tbody>
                            <tr>
                                <td class="float-sm" width="16">&nbsp;</td>
                                <td>
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                        ...
                                        <tr>
                                            <td width="100%" align="start" style="font-size:0px; padding: 16px; background-color: #FFFFFF; border-radius: 8px">
                                                ...
                                                <p style="Margin:0;font-family:'DM Sans', Arial;font-size:18px;line-height:normal;color:#0066FF;font-weight:700;text-align:start">
                                                    Convenience
                                                </p>
                                                <p style="Margin:0;height:8px;line-height:8px">
                                                    &nbsp;
                                                </p>
                                                <p style="Margin:0;font-family:'DM Sans', Arial;font-size:16px;line-height:normal;color:#22242B;font-weight:400;text-align:start">
                                                    Purchase ETF shares directly through BitcoinETF.org at a stable price point, ensuring
                                                    clarity and consistency in your investment.
                                                </p>
                                            </td>
                                        </tr>
                                        </tbody>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                        ...
                                        <tr>
                                            <td width="100%" align="start" style="font-size:0px; padding: 16px; background-color: #FFFFFF; border-radius: 8px">
                                                ...
                                                <p style="Margin:0;font-family:'DM Sans', Arial;font-size:16px;line-height:normal;color:#22242B;font-weight:400;text-align:start">
                                                    Experience peace of mind knowing that the fund is dedicated to honoring buy-back commitments
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                        ...
                                        <tr>
                                            <td width="100%" align="start" style="font-size:0px; padding: 16px; background-color: #FFFFFF; border-radius: 8px">
                                                ...
                                                <p style="Margin:0;font-family:'DM Sans', Arial;font-size:16px;line-height:normal;color:#22242B;font-weight:400;text-align:start">
                                                    Look forward to receiving daily dividends credited directly to your cold wallet, augmenting
                                                    your investment with stable returns.
                                                </p>
                                            </td>
                                        </tr>
                                        </tbody>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                        ...
                                        <tr>
                                            <td width="100%" align="start" style="font-size:0px; padding: 16px; background-color: #FFFFFF; border-radius: 8px">
                                                ...
                                                <p style="Margin:0;font-family:'DM Sans', Arial;font-size:16px;line-height:normal;color:#22242B;font-weight:400;text-align:start">
                                                    Our team is here to assist you every step of the way, ensuring a smooth transition from
                                                    registration to full-fledged client status.
                                                </p>
                                            </td>
                                        </tr>
                                        </tbody>
                                ...
                                <td>
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt">
                                        ...
                                        <tr>
                                            ...
                                            <td class="float-lg" width="343" align="start" valign="start">
                                                <p style="Margin:0;font-family:'DM Sans', Arial;font-size:24px;line-height:normal;color:#22242B;font-weight:700;text-align:start">
                                                    We invite you to <span style="Margin:0;font-family:'DM Sans', Arial;font-size:24px;line-height:normal;color:#0066FF;font-weight:700;text-align:start;">explore the possibilities that await you</span>
                                                    at BitcoinETF.org
                                                </p>
                                            </td>
                                            <td class="float-sm" width="16">&nbsp;</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="float-lg" width="343" align="start" valign="center">
                                                <p style="Margin:0;font-family:'DM Sans',Arial,sans-serif;font-size:16px;line-height:24px;color:#000; text-align: start; font-weight: 400">
                                                    Select the amount of shares you wish to acquire, review your guaranteed dividends, and
                                                    finalize your purchase at your convenience.
                                                    <br>
                                                    <br>
                                                    Thank you for choosing to explore the potential of decentralized ETFs with us. Should you
                                                    have any queries or require assistance, please do not hesitate to reach out to our support
                                                    team.
                                                    <br>
                                                    <br>
                                                    We look forward to a prosperous and enduring partnership.
                                                    <br>
                                                    <br>
                                                    Warm regards,
                                                    <br>
                                                    <br>
                                                    <span style="Margin:0;font-family:'DM Sans',Arial,sans-serif;font-size:16px;line-height:24px;color:#000; text-align: start; font-weight: 700">The BitcoinETF.org Team</span>
                                                </p>
                                            </td>
                                            <td class="float-sm" width="16">&nbsp;</td>
                                        </tr>
